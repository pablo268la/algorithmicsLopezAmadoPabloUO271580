...
public class BoggleAllBacktrackingRepetitionsTest {
	...
	public void testCase03() {
    	...
    	assertEquals(421, problem.getTotalPoints());
	}
	...
	public void testCase05() {
    	...
    	assertEquals(2447, problem.getTotalPoints());
	}
	...
	public void testCase15() {
    	...
    	assertEquals(13207, problem.getTotalPoints());
	}
	...
	public void testCase46() {
    	...
    	assertEquals(114245, problem.getTotalPoints());
	}
	...
	public void testCase100() {
    	...
    	assertEquals(2052, problem.getTotalPoints());
	}
	...
	public void testCase205() {
    	...
    	assertEquals("you", problem.getSolutions().get(95));
    	assertEquals(1722, problem.getTotalPoints());
	}
	...
	public void testCase205_2() {
    	...
    	assertEquals("shilling", problem.getSolutions().get(32631));
    	assertEquals(698733, problem.getTotalPoints());
	}
}
